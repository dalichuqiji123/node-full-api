...
var goodModel = require('../model/cms/addgood')
var cateModel = require('../model/catesModle')
var userModel = require('../model/userModle');

var cartModel = require('../model/webapp/cartModel')  // carts
var orderModel = require('../model/webapp/orderModel') // orders
var adModel = require('../model/adModel')  // ads
...
//   limit(size).skip((page-1)*size).sort({rank: -1})
  goodModel.find({goodsType:cate}).then(arr=>{
    res.json({err:0,msg:'success',data:arr})
  }).catch(err=>{
    res.json({err:1,msg:'fail',err})
  })
